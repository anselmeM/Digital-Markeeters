...
const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'glass-pavilion',
    year: '2024',
    services: 'Photography / Architecture',
      ...
      <div className="flex flex-wrap gap-3 md:gap-4 mb-12">
        {filters.map((filter) => (
          <motion.button
            ...
            className={`px-4 py-2 text-sm uppercase tracking-widest border transition-all duration-200 ease-out cursor-pointer ${
              activeFilter === filter
